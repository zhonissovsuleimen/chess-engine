...
mod tests {
  ...
  mod bishop {
    ...
    fn default_on_edge() {
      ...
      let ally_bishops = movegen.bishops & movegen.ally;
      assert_eq!(movegen.bishop(ally_bishops), 0x00_A0_10_08_04_02_01_00);
      movegen.switch_turn();
      let ally_bishops = movegen.bishops & movegen.ally;
      assert_eq!(movegen.bishop(ally_bishops), 0x00_01_02_04_08_10_A0_00);
    }
